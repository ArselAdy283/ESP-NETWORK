...
export const user = mysqlTable("web_user", {
	...
	image: text("image"),
	javaUsername: varchar("javaUsername", { length: 255 }).unique(),
	bedrockUsername: varchar("bedrockUsername", { length: 255 }).unique(),
	javaTextureId: text("javaTextureId"),
	bedrockTextureId: text("bedrockTextureId"),
